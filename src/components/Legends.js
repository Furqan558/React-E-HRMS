      ...
      <div className="row">
        <div className="col-12 col-sm-6 col-md-3">
          <div className="info-box">     
            ...
            <div className="info-box-content">
              <span className="info-box-text">  Total UAT's </span>
        ...
        <div className="col-12 col-sm-6 col-md-3">
          <div className="info-box mb-3">
            ...
            <div className="info-box-content">
              <span className="info-box-text">PASS</span>
              <span className="info-box-number">
                123
              </span></div>
            {/* /.info-box-content */}
        ...
        <div className="col-12 col-sm-6 col-md-3">
          <div className="info-box mb-3">
            ...
            <div className="info-box-content">
              <span className="info-box-text">Fail</span>
              <span className="info-box-number" >
              0
              </span>
            </div>
        ...
        <div className="col-12 col-sm-6 col-md-3">
          <div className="info-box mb-3">
            ...
            <div className="info-box-content">
              <span className="info-box-text">Total Executed Test</span>
              <span className="info-box-number" >
              4
              </span>
            </div>
